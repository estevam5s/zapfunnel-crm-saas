    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      ...
      <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground">
        <div className="relative z-20">
          <Link href="/" className="flex items-center gap-2 text-lg font-semibold">
            {/* logo real (transparente, sem moldura branca) */}
            <img src="/brand-logo.png" alt="ZapFunnel" className="h-11 w-auto object-contain drop-shadow" />
            <span>ZapFunnel</span>
          </Link>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[420px]">
          ...
          >
            <img src="/brand-logo.png" alt="ZapFunnel" className="h-11 w-auto object-contain" />
            <span>ZapFunnel</span>
          </Link>
          ...
          <div className="mt-6">
            ...
            >
              <svg viewBox="0 0 24 24" className="mr-2 size-5"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.27-4.74 3.27-8.1Z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84A11 11 0 0 0 12 23Z"/><path fill="#FBBC05" d="M5.84 14.1a6.6 6.6 0 0 1 0-4.2V7.06H2.18a11 11 0 0 0 0 9.88l3.66-2.84Z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1A11 11 0 0 0 2.18 7.06l3.66 2.84C6.71 7.3 9.14 5.38 12 5.38Z"/></svg>
              Entrar com o Google
            </Button>
          </div>
